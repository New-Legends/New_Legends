...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of Lifting */
  osThreadDef(Lifting, Lifting_task, osPriorityNormal, 0, 128);
  LiftingHandle = osThreadCreate(osThread(Lifting), NULL);
